...
public record GeometryGroup : Drawing
{
    ...
    public GeometryGroup(ShimSkiaSharp.SKPicture? picture = null, ResourceDictionary? resources = null, string? key = null)
    {
        Key = key;
        Picture = picture;
    ...
    private void Initialize(ShimSkiaSharp.SKPicture? picture, ResourceDictionary? resources = null)
    {
        ...
        var layerStack = new Stack<GeometryGroup>();
        ...
        foreach (var canvasCommand in picture.Commands)
        {
            switch (canvasCommand)
            {
                case ShimSkiaSharp.ClipPathCanvasCommand(var clipPath, _, _):
                {
                    ...
                    var newLayer = new GeometryGroup
                    {
                        ClipGeometry = path
                    };
                ...
                case ShimSkiaSharp.DrawPathCanvasCommand(var skPath, var skPaint):
                {
                    ...
                    var geometryDrawing = new PathGeometry(skPaint, path, resources);
